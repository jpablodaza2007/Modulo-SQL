# Códigos MySQL con Juan Pablo Daza
...
-- 4. Crear Tabla de Vendedores (adaptada a Juan Pablo Daza)
...
VALUES ('Juan Pablo Daza', 'Masculino', 'Activo');

-- 52. Insertar con SET
INSERT INTO empleados_habilidades(empleado_id, nombre, habilidades)
VALUES (1, 'Juan Pablo Daza', 'MySQL,PHP,Python');
...
VALUES 
('Reunión con Juan Pablo Daza', '2024-03-15', '14:30:00', '2024-03-15 14:30:00'),
...
SELECT 
  REPLACE(nombre_pila, 'Juan Pablo', 'Juan') as nombre_modificado
FROM vendedores;
...
CALL ObtenerVentasPorVendedor('Juan Pablo');
...
-- Consulta del perfil completo de Juan Pablo Daza
SELECT 
  numero_empleado,
  CONCAT(nombre_pila, ' ', apellido) as nombre_completo,
...
WHERE ven.nombre_pila = 'Juan Pablo'
